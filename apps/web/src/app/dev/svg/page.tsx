...
export default function TestPage({ progress }: { progress: number }) {
  ...
  useEffect(() => {
    ...
    function animate(now: number) {
      ...
      if (exitStart) {
        ...
        grad.setAttribute('x1', pct(leadPos - FALLOFF * 4));
        grad.setAttribute('x2', pct(leadPos + FALLOFF * 2));
      }
